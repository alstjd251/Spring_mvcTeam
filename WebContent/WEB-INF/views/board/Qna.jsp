		...
		<div class="panel-group" id="accordion" role="tablist"
			...
			<div class="panel panel-default">
				<div class="panel-heading" role="tab" id="headingOne">
					<h4 class="panel-title">
						<a data-toggle="collapse" data-parent="#accordion"
							...
							aria-controls="collapseOne"> Q. 예약 당일에 양조장의 문제로
							취소되면 어떻게 되나요? </a>
					</h4>
				</div>
				<div id="collapseOne" class="panel-collapse collapse in"
					...
					<div class="panel-body">
						A. 먼저 주변의 다른 양조장으로 안내를 도와드리고 있습니다.<br /> 코스 상황에 따라 다른 장소로 이동하지 못할
				...
				<div class="panel-heading" role="tab" id="headingTwo">
					<h4 class="panel-title">
						<a class="collapsed" data-toggle="collapse"
							...
							Q. 코스 전체가 아닌 일정 양조장만 가고 싶습니다. </a>
					</h4>
				</div>
				<div id="collapseTwo" class="panel-collapse collapse"
					role="tabpanel" aria-labelledby="headingTwo">
					<div class="panel-body">
						A. 죄송합니다. 현재까지는 안전상의 문제로 지정된 코스만 이용 가능합니다.<br /> 자율 선택형 코스는 추후에
				...
				<div class="panel-heading" role="tab" id="headingThree">
					<h4 class="panel-title">
						<a class="collapsed" data-toggle="collapse"
							...
							Q. 시간이 마음에 들지 않습니다. 오전 시간에 출발할 수 있을까요? </a>
					</h4>
				</div>
				<div id="collapseThree" class="panel-collapse collapse"
					role="tabpanel" aria-labelledby="headingThree">
					<div class="panel-body">A. 코스 시간은 해당 코스의 관계자 분들과의 상의로 결정된
						시간으로 조정이 불가능합니다.
					</div>
				</div>
			</div>
				...
				<div class="panel-heading" role="tab" id="headingFour">
					<h4 class="panel-title">
						<a class="collapsed" data-toggle="collapse"
							...
							Q. 출발 시간에 맞추지 못하면 어떻게 되나요? </a>
					</h4>
				</div>
				<div id="collapseFour" class="panel-collapse collapse"
					role="tabpanel" aria-labelledby="headingFour">
					<div class="panel-body">
						A. 원칙적으로 정시 출발을 하고 있으나, 천재지변 및 교통문제(기차,고속버스)로 인한 경우<br /> 최대
			...
			<div class="panel panel-default">
				...
				<div id="collapseFive" class="panel-collapse collapse"
					...
					<div class="panel-body">A. 운전기사 및 다른 고객님들의 안전을 위해 차내 음주는 금지하고
						있습니다.
					</div>
				</div>
			</div>
			<div class="panel panel-default">
				...
				<div id="collapseSix" class="panel-collapse collapse"
					...
					<div class="panel-body">
						A. 현재까지는 시음을 중심으로 운영하고 있습니다. 직접 술을 만드는 등의 체험은<br /> 추후에 도입될
						예정입니다.
					</div>
				</div>
			</div>
			<div class="panel panel-default">
				<div class="panel-heading" role="tab" id="headingSeven">
					<h4 class="panel-title">
						<a class="collapsed" data-toggle="collapse"
							...
							Q. 관광지에서 집결지로 바로 이동할 예정입니다. 짐을 보관할 장소가 있을까요? 
						</a>
					</h4>
				</div>
				<div id="collapseSeven" class="panel-collapse collapse"
					...
					<div class="panel-body">
						A. 주변 역의 물품보관함을 이용하시거나 20인치 이하의 캐리어인 경우<br /> 트렁크에 보관을 도와드리고
						있습니다.
					</div>
				</div>
			</div>
