...
<!-- 로그인 모달 -->
    ...
    <header>
      <div class="logo">
        <a href="#"><img src="C:/Users/USER/Desktop/3/logoimg.jpg" /></a>
      </div>
      <div class="menu_bar">
      ...
      <div class="login">
        <a href="#" id="popup_open_btn"
          ><img src="C:/Users/USER/Desktop/3/loginimg.jpg"
        /></a>
      </div>
    </header>
    <!-- 섹션 -->
    <div class="section" dir="ltr">
      ...
      <div id="fade1" class="sect">
        <li>
          <img src="C:/Users/USER/Desktop/3/img1.jpg" class="img1" />
        </li>
        <li>
          <img src="C:/Users/USER/Desktop/3/img2.jpg" class="img2" />
        </li>
        <li>
          <img src="C:/Users/USER/Desktop/3/img3.jpg" class="img3" />
        </li>
        <li>
          <img src="C:/Users/USER/Desktop/3/img4.jpg" class="img4" />
        </li>
        <li>
          <img src="C:/Users/USER/Desktop/3/img5.jpg" class="img5" />
        </li>
      </div>
      ...
      <div id="yang01" class="sect" style="background-color: pink">
        ...
        <div class="chi-course01">
          <div id="course01-image01"><img src="C:/Users/user/Desktop/코스 포토샵/코스 포토샵/서울코스_서울.png"></div>
        ...
        <div class="chi-course02">
          ...
          <div id="course01-image02"><img src="C:/Users/user/Desktop/코스 포토샵/코스 포토샵/경기도코스_안산.png"></div>
        </div>
        <div class="chi-course03">
          <div id="course01-image03"><img src="C:/Users/user/Desktop/코스 포토샵/코스 포토샵/충북코스_단양.png"></div>
      ...
      <div id="yang02" class="sect" style="background-color: bisque">
        ...
        <div class="chi-course04">
          ...
          <div id="course02-image04"><img src="C:/Users/user/Desktop/코스 포토샵/코스 포토샵/전라도코스_담양.png"></div>
        </div>
        <div class="chi-course05">
          <div id="course02-image05"><img src="C:/Users/user/Desktop/코스 포토샵/코스 포토샵/경상도코스_경북_안동.png"></div>
        ...
        <div class="chi-course06">
          ...
          <div id="course02-image06"><img src="C:/Users/user/Desktop/코스 포토샵/코스 포토샵/경상도코스_경남_부산.png"></div>
        </div>
        </div>
      </div>
      ...
      <div id="footad" class="sect">
        <div id="ad">
          <li><a href="#"><img src="C:/Users/user/Desktop/1330.jpg" class="pimg"></a></li>
          <li><a href="#"><img src="C:/Users/user/Desktop/야놀자.png" class="pimg"></a></li>
          <li><a href="#"><img src="C:/Users/user/Desktop/하미앙.png" class="pimg"></a></li>
          <li><a href="#"><img src="C:/Users/user/Desktop/여긴어때.png" class="pimg"></a></li>
          <li><a href="#"><img src="C:/Users/user/Desktop/숙박대전.jpg" class="pimg"></a></li></div>
        <footer>
          <div class="FOOTER_TOTAL">
                <div class="F_i F_i1">
                  <img src="C:/Users/USER/Desktop/3/M_LOGE.jpg">
                  <p><strong>대표자</strong>_박치언</p>
                  <p><strong>사업자등록번호</strong> 052-34-56789</p>
                  <p>통신판매업신고 제2015-울산울주-0164호</p>
                </div>
                <div class="F_i F_i2">
                  <img src="C:/Users/USER/Desktop/3/location.png" width="180px">
                  <p><strong>울산광역시 울주군 상북면 향산동길 48</strong></p>
                </div>
                <div class="F_i F_i3"><img src="C:/Users/USER/Desktop/3/call.png" width="180px">
                  <p>전화 052-879-1234</p>
                  <p>팩스&nbsp;&nbsp;1577-6746</p>
                  <p>soldesk@gmail.com</p>
                </div>
                <div class="F_i F_i4"><img src="C:/Users/USER/Desktop/3/open.png" width="180px">
    ...
    <script type="text/javascript" src="js/sooldesk.js"></script>
