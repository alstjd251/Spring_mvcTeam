...
public interface BreweryMapper {
	...
	void addNotice(Brewery_s breweryBean);
	
	@Delete("delete from brewery_s where brew_code LIKE #{brew_code}")
	void deleteNotice(Brewery_s breweryBean);
